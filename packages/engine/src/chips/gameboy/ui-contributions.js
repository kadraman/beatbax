...
const helpSections = [
    {
        ...
        content: [
            { kind: 'text', text: 'All four Game Boy channels have their own instrument type.' },
            {
                ...
                code: `inst lead type=pulse1 duty=50 env=12,down
# duty: 12 | 25 | 50 | 75
# env: <volume>,<direction>  direction = up | down | flat`,
            },
            {
                ...
                code: `inst wv type=wave wave=[0,3,6,9,12,9,6,3,0,3,6,9,12,9,6,3]
# wave: 16 nibble values (0-15) defining the 4-bit wavetable`,
            },
            {
                kind: 'snippet',
                label: 'Noise channel (type=noise)',
                code: `inst sn type=noise env=12,down
...
# width=7 for metallic/tonal; width=15 for full noise`,
            },
            {
                ...
                code: `inst lead type=pulse1 duty=50 env=gb:12,down,1
...
# period 0 = constant  1 = fastest decay  7 = slowest`,
            },
            {
                ...
                code: `inst laser type=pulse1 duty=50 sweep=4,down,7
...
// ─── Export ───────────────────────────────────────────────────────────────────
export const gameboyUIContributions = {
    copilotSystemPrompt,
    hoverDocs,
    helpSections,
};
//# sourceMappingURL=ui-contributions.js.map