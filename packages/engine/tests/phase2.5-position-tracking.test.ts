...
import { Player, createAudioContext } from '../src/audio/playback';
...
channel 4 => seq main
  ...
  describe('Player position tracking', () => {
    it.skip('should initialize position tracking maps on playback', async () => {
      const script = `
chip gameboy
bpm 240
...
channel 1 => inst lead seq main
    ...
    it.skip('should fire onPositionChange callback for each event', async () => {
      const script = `
chip gameboy
bpm 240
...
channel 1 => inst lead seq main
    ...
    it.skip('should include eventIndex and totalEvents in onSchedule callback', async () => {
      const script = `
chip gameboy
bpm 240
...
channel 1 => inst lead seq main
    ...
    it.skip('should track position for multiple channels independently', async () => {
      const script = `
chip gameboy
bpm 240
...
channel 2 => inst bass seq bassSeq
  ...
  describe('Integration tests', () => {
    it.skip('should provide complete position tracking for a multi-channel song', async () => {
      const script = `
chip gameboy
bpm 240
