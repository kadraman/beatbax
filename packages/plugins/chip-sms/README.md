...
inst harm  type=tone2   vol=8  vol_env=[12,10,8,6]
inst bass  type=tone3   vol=12
inst kick  type=noise   noise_mode=white noise_rate=2 vol_env=[15,10,5,0]
...
| Volume slide (volSlide) | ✅ | Per-tick attenuation writes |
...
inst snare type=noise noise_mode=white noise_rate=1 vol_env=[14,10,6,0]
inst hihat type=noise noise_mode=white noise_rate=0 vol=8 vol_env=[10,5,0]
