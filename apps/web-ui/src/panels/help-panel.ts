...
seq arp_line = arp_source:arp(4,7)` },
  ...
  },
  {
    ...
    content: [
      ...
      { kind: 'shortcut', keys: ['Alt', 'Shift', 'L'],  desc: 'Theme (Dark / Light)' },
      { kind: 'shortcut', keys: ['Ctrl', '`'],          desc: 'Show Output panel' },
      { kind: 'shortcut', keys: ['Alt', 'Shift', 'P'],  desc: 'Show Problems panel' },
      { kind: 'shortcut', keys: ['Ctrl', 'Shift', 'V'], desc: 'Show Song Visualizer' },
      { kind: 'shortcut', keys: ['Alt', 'Shift', 'V'],  desc: 'Verify syntax' },
      { kind: 'shortcut', keys: ['Alt', 'Shift', 'B'],  desc: 'Toggle Toolbar' },
      { kind: 'shortcut', keys: ['Alt', 'Shift', 'R'],  desc: 'Toggle Transport Bar' },
    ],
  },
  {
    id: 'examples',
