/**
 * icons.ts - Heroicons v2 (outline, 24x24) as inline SVG strings.
 *
 ...
 *                 Defaults to `"w-4 h-4"` (16x16 px via Tailwind).
 */
...
/**
 * Return an inline SVG for a social / brand logo (GitHub, X, itch.io, etc.).
 */
