...
- **Runtime boundary:** Use `@beatbax/engine` for browser-safe/core plugin APIs (types, registry, music utilities). Do **not** import `@beatbax/engine/node` from browser-targeted plugin runtime modules.
