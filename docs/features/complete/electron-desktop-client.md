...
Post-MVP items (auto-update, Windows Authenticode, power features, etc.) are tracked in [desktop-client-enhancements.md](./desktop-client-enhancements.md).
...
3. **Code signing:** macOS Developer ID + notarization is configured for GitHub Release CI. Windows Authenticode (SmartScreen) remains open — see [desktop-client-enhancements.md](./desktop-client-enhancements.md).
